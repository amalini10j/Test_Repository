--Create schema for covid19_data_analysis database
CREATE SCHEMA covid
...
select * from clean_covid_dataset;
select * from column_description;
select * from catalogs;
select d.id,d.sex,c.column_value_description from covid_dataset d inner join catalogs c on d.sex = cast(c.column_value as bigint)
where c.column_name = 'sex';

-- drop table clean_covid_dataset;
-- drop table covid_dataset;
